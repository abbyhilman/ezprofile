...
module.exports = {
    github: {
        ...
        exclude: {
            ...
            projects: ['Food-Market-Back-End-Laravel', 'learn-tailwindcss'] // These projects will not be displayed. example: ['my-project1', 'my-project2']
        }
    },
    social: {
        linkedin: 'abby-hilman-696479152',
        twitter: '',
        facebook: '',
        dribbble: '',
        behance: '',
